...
export class LoginUserDataDto {
  @ApiProperty({
    ...
    example:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjIsImVtYWlsIjoiZHJhZ29zQGV4YW1wbGUuY29tIiwicm9sZSI6Ik9XTkVSIiwiaWF0IjoxNzg1OTk4NjkzLCJleHAiOjE3ODYwODUwOTN9.K5WhoSvQgJARLFAqr8CQdo-oeSy-nkXr9FykC0EZAy4',
  })
  token!: string;

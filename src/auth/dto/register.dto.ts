...
export class RegisterUserDto {
  ...
  @ApiProperty({
    description: 'Active email use for login',
  ...
  @ApiProperty({
    description: 'Minimum password has 8 characther',
    example: 'fullofsecret123',
    minLength: 8,
  })
  @IsString()
  ...
  @ApiProperty({
    description: 'Address of pet owner',
    example: 'Jl. Kebayoran Lama',
  })
  @IsString()
  address!: string;
}

...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve account data who currently login with profile detail',
  })
  @ApiResponse({
    status: 200,
    description: 'Success',
  ...
  @ApiOperation({
    ...
    description:
      'Change password user who currently login. Need bearer token in Authorization header',
  })
  @ApiResponse({
    status: 200,
  ...
  async findAllPagination(@Query() paginationDto: PaginationDto) {
    return this.userService.findAllPaginatedUser(paginationDto);
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a specific user by their ID. Only accessible by Super Admin and Admin',
  })
  @ApiParam({
    name: 'id',
    description: 'User ID',
  ...
  @ApiOperation({
    summary: 'Update user credential by Admin / Super Admin',
    description: 'User credential update by ID, only Admin and Super Admin can access'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 400,
    description: 'Invalid input user credential'
  })
  @ApiResponse({
    status: 401,
    description: 'Unauthorized - Token missing or invalid',
  ...
  @ApiOperation({
    ...
    description:
      'Password user update by ID, only Admin and Super Admin can access ',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Soft Delete user Account, Only accessible for Admin and Super Admin',
  })
  @ApiResponse({
    status: 200,
